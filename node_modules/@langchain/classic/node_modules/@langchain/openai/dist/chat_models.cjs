...
var BaseChatOpenAI = class extends __langchain_core_language_models_chat_models.BaseChatModel {
	...
	*/
	...
	constructor(fields) {
		super(fields ?? {});
		this.apiKey = fields?.apiKey ?? fields?.configuration?.apiKey ?? (0, __langchain_core_utils_env.getEnvironmentVariable)("OPENAI_API_KEY");
	...
	*/
	...
	bindTools(tools, kwargs) {
		...
		return this.withConfig({
			tools: tools.map((tool) => require_tools.isBuiltInTool(tool) ? tool : this._convertChatOpenAIToolToCompletionsTool(tool, { strict })),
			...kwargs
		});
	}
...
var ChatOpenAI = class ChatOpenAI extends BaseChatOpenAI {
	...
	*/
	...
	_useResponsesApi(options) {
		...
		const hasCustomTools = options?.tools?.some(require_tools.isOpenAICustomTool);

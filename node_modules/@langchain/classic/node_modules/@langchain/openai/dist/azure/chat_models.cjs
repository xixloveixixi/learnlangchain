...
//#region src/azure/chat_models.ts
const AZURE_ALIASES = {
...
var AzureChatOpenAIResponses = class extends require_chat_models.ChatOpenAIResponses {
	azureOpenAIApiVersion;
	azureOpenAIApiKey;
...
var AzureChatOpenAICompletions = class extends require_chat_models.ChatOpenAICompletions {
	azureOpenAIApiVersion;
	azureOpenAIApiKey;
	azureADTokenProvider;
	azureOpenAIApiInstanceName;
...
* </details>
*/
var AzureChatOpenAI = class extends require_chat_models.ChatOpenAI {
	azureOpenAIApiVersion;
	azureOpenAIApiKey;
	azureADTokenProvider;
	azureOpenAIApiInstanceName;
